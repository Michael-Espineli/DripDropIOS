...
#sourceLocation(file: "/Users/michaelespineli/Desktop/DripDrop/DripDrop/Modules/StopData/StopDataViewModel.swift", line: 1)
//
...
final class StopDataViewModel:ObservableObject{
    ...
    func getFourMostRecentServiceStopsByBodyOfWater(companyId:String,bodyOfWaterId: String)async throws{
        ...
        let customerStopData = try await dataService.getRecentServiceStopsByBodyOfWater(companyId: companyId, bodyOfWaterId: bodyOfWaterId, amount: __designTimeInteger("#23031_0", fallback: 4))
