...
//
//
//DEVELOPER EXACTLY WHAT EMPLOYEE DASHBOARD WAS BEFORE I STARTED TO CUT IT UP
import SwiftUI
...
//                   content: {
//                AddNewRepairRequest(dataService: dataService,isPresented:$showRepairSheet)
//            })
...
//                    idItem = IdInfo(id: "Hello", internalId: "")
        ...
        .padding(EdgeInsets(top: 4, leading: 10, bottom: 4, trailing: 8))
    }
