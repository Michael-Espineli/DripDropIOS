//
//  ReceivedRecurringLaborContractListView.swift
//  DripDrop
//
//  Created by Michael Espineli on 5/16/25.
//
//
...
@MainActor
final class ReceivedRecurringLaborContractListViewModel:ObservableObject{
...
struct ReceivedRecurringLaborContractListView: View {
    @EnvironmentObject var masterDataManager: MasterDataManager
    @EnvironmentObject var dataService : ProductionDataService
    
    @StateObject var VM : ReceivedRecurringLaborContractListViewModel
    
    init(dataService:any ProductionDataServiceProtocol) {
        _VM = StateObject(wrappedValue: ReceivedRecurringLaborContractListViewModel(dataService: dataService))
    }
